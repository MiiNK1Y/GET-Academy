...
-------------------------------";
    ...
    internal static string RaceResults { get; private set; } = @"-*_-*_-*_-* RESULTS *-_*-_*-_*-";
    internal static string SelectHorse { get; private set; } = @"==---> Select your horse <---==";

    internal static string FeedYourHorses { get; private set; } = @"=======--->> FEED <<---========";
    internal static string GroomYourHorses { get; private set; } = @"======--->>> GROOM <<<---======";
