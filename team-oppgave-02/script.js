...
function startCounter() {
    setInterval(feedCounting, 300);
    setInterval(peeCounting, 800);
    setInterval(entertainCounting, 400);
    setInterval(cuddleCounting, 700);
    setInterval(coffeeCounting, 500);
    setInterval(catnipCounting, 200);
}
